...
```
CLAIM_SIMILARITY, DISEASE, DISEASE_ONTOLOGY, HAS_DISEASE, INCHARGE, INCHARGE_OF_CLAIM, INSURED_OF_CLAIM, PATIENT, POLICYHOLDER, POLICYHOLDER_CONNECTION, POLICYHOLDER_OF_CLAIM, SERVICE
```
